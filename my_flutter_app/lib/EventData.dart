class EventData {
  ...
  factory EventData.fromJson(Map<String, dynamic> json) {
    final data = <EventName, Map<SwimClass, Map<Gender, BCValues>>>{};
    final eventData = json['event_data'] as Map<String, dynamic>;

    for (final eventEntry in eventData.entries) {
      final eventEnum = stringToEventEnum(eventEntry.key);
      final classMap = <SwimClass, Map<Gender, BCValues>>{};

      for (final classEntry in (eventEntry.value as Map<String, dynamic>).entries) {
        final classEnum = stringToSwimClass(classEntry.key);
        final genderMap = <Gender, BCValues>{};

        for (final genderEntry in (classEntry.value as Map<String, dynamic>).entries) {
          final genderEnum = stringToGender(genderEntry.key);
...
final Map<String, List<String>> eventToClasses = {
  "50 m Freestyle": ["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13"],
  "100 m Freestyle": ["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],
  "200 m Freestyle": ["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],
  "400 m Freestyle": ["S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],
  "800 m Freestyle": ["S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],
  "1500 m Freestyle": ["S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],

  "50 m Backstroke": ["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13"],
  "100 m Backstroke": ["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],
  "200 m Backstroke": ["S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],

  "50 m Breaststroke": ["SB1", "SB2", "SB3", "SB4", "SB5", "SB6", "SB7", "SB8", "SB9", "SB11", "SB12", "SB13"],
  "100 m Breaststroke": ["SB1", "SB2", "SB3", "SB4", "SB5", "SB6", "SB7", "SB8", "SB9", "SB11", "SB12", "SB13", "SB14"],
  "200 m Breaststroke": ["SB4", "SB5", "SB6", "SB7", "SB8", "SB9", "SB11", "SB12", "SB13", "SB14"],

  "50 m Butterfly": ["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13"],
  "100 m Butterfly": ["S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14"],
  "200 m Butterfly": ["S8", "S9", "S10", "S11", "S12", "S13", "S14"],

  "150 m IM": ["SM1", "SM2", "SM3", "SM4"],
  "200 m IM": ["SM3", "SM4", "SM5", "SM6", "SM7", "SM8", "SM9", "SM10", "SM11", "SM12", "SM13", "SM14"],
  "400 m IM": ["SM8", "SM9", "SM10", "SM11", "SM12", "SM13", "SM14"],
};
...
SwimClass stringToSwimClass(String str) {
  try {
    return SwimClass.values.firstWhere((e) => e.name == str);
  } catch (e) {
...
Gender stringToGender(String str) => Gender.values.firstWhere((e) => e.name == str.toLowerCase());